...
| <p align="center"><img src="./images/handwritten/page-t2i-generation-en-output2.png" width=100%></p> | Add an embossed word that reads “Sun rises.” in the appropriate place. | EN       | <p align="center"><img src="./images/handwritten/page-text-editing-en-output2.png" width=100%></p> | ❌<br/>Text are added but some texts are cropped and image is squared. |
...
| A smartphone back with the brand name 'TechFuture' subtly printed in a stylish font. The phone has a glossy finish and is reflecting light. | EN | <p align="center"><img src="./images/object/t2i-generation-en-output4.png" width=100%></p> | ✅<br/>Requirements fulfilled. High quality. |
| A bicycle computer showing the speed and distance traveled in a digital font. The display reads '25.5 km/h' and '15.2 km'. | EN | <p align="center"><img src="./images/object/t2i-generation-en-output5.png" width=100%></p> | ✅<br/>Requirements fulfilled. High quality. |
...
| <p align="center"><img src="./images/object/object-text-editing-zh-input.jpg" width=100%></p> | 将0改成7，“冷藏”改成“风速” | ZH | <p align="center"><img src="./images/object/object-text-editing-zh-output.png" width=100%></p> | 🤔<br/>Partially good. The number is correctly modified while the Chinese text is not. Other text are not precisely retained. |
| <p align="center"><img src="./images/object/object-text-editing-en-input.png" width=100%></p> | Modify "F5.6" to "OK.8" and "ONE" to "FOUR" | EN | <p align="center"><img src="./images/object/object-text-editing-en-output.png" width=100%></p> | 🤔<br/>Partially good. Correct modification. But the image is accidentally squared. |
...
## <div align="center" id="contact">Layout-aware Text Generation</div> <!-- omit in toc -->
